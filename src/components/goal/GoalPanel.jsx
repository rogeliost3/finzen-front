  ...
  return (
    <div className="panel">
      ...
      <div className="label">
        ...
        <div>
          {goalSelected?.createdAt ? goalSelected.createdAt.split("T")[0] : ""}
        </div>
      </div>
      ...
      <div className="label">
        ...
        <div>
          {goalSelected?.currentAmount ? goalSelected.currentAmount : ""} €
        </div>
      </div>
      ...
      <div className="field">
        ...
        <input
          type="date"
          value={
            goalSelected?.deadline ? goalSelected.deadline.split("T")[0] : ""
          }
      ...
      <div className="button-row merge2">
        <button onClick={onSave} name="buttonSave" className="button save">
          Save
        </button>
        {!isNew && goalSelected && (
          <button
        ...
        {!isNew && (
          <button onClick={onNew} name="buttonNew" className="button new">
            New
          </button>
        )}
        {!isNew && (
